...
export const auditActionEnum = pgEnum('audit_action', ['create', 'update', 'delete', 'view', 'ai_narrative_generated', 'ai_schedule_o_narrative_generated', 'audit_retention_manual_trigger', 'bulk_reconciled', 'chain_repair', 'split', 'unsplit', 'mfa_requirement_updated', 'mfa_setup_verification_failed', 'mfa_enabled', 'mfa_backup_code_failed', 'mfa_backup_code_used', 'mfa_verification_failed', 'mfa_verified', 'mfa_login_backup_code_failed', 'mfa_login_backup_code_verified', 'mfa_login_verification_failed', 'mfa_login_verified', 'mfa_disabled', 'mfa_backup_codes_regenerated']);
...
export const subAwards = pgTable("sub_awards", {
  ...
  subrecipientEIN: varchar("subrecipient_ein", { length: 100 }),
  ...
  complianceStatus: varchar("compliance_status", { length: 100 }).notNull().default('compliant'),
